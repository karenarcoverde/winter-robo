...
* **[códigos_robo](https://github.com/karenarcoverde/winter-robo/tree/master/codigos_robo):** Códigos utilizados para testar as rodas e a Robô Winter com a função de desviar obstáculos.
...
* **[teste_rodas](https://github.com/karenarcoverde/winter-robo/blob/master/c%C3%B3digos_robo/teste_rodas/teste_rodas.ino):** Código utilizado para testar se as rodas estão girando para o lado correto. Caso esteja girando para o lado errado, basta inverter os terminais positivo e negativo do motor na ligação da ponte H L9110. <br>
